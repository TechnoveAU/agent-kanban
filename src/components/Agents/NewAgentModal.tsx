        ...
        <form onSubmit={handleSubmit} className="px-6 py-5 space-y-5">
          ...
          <div className="space-y-1.5">
            <label className="block text-sm font-semibold text-gray-700">
              ID{' '}
              <span className="text-xs font-normal text-gray-400">(optional — auto-generated if blank)</span>
            </label>
            <input
              type="text"
              value={id}
              ...
              className="w-full border border-gray-200 rounded-lg px-4 py-2.5 text-sm text-gray-800 placeholder-gray-400 font-mono focus:outline-none focus:ring-2 focus:ring-red-800/50 focus:border-red-800"
            />
          </div>
